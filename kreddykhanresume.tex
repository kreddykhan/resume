...
\begin{setmargins}{Experience}
  ...
  \emph{Software Development Engineer}
  \begin{itemize}
    \item Implemented A/B tests to improve customer reservation rate and retention
...
\begin{setmargins}{Skills}
  ...
  Java, Ruby, JavaScript, HTML, React, Ruby on Rails, Matlab\\
  \note{\textbf{\normalsize AWS}}
...
\begin{setmargins}{Interests}
  Boxing, rock climbing, comic books, video games, theatre\\
\end{setmargins}
