...
\begin{setmargins}{Projects}
  ...
  \href{https://github.com/kreddykhan/quantum-escapement}{\textcolor{black}{\faGithubAlt}} \enskip \textbf{Quantum Escapement:} Escape the room style game built using Blender and Python\\
  \note{\textbf{\small Sep 2016 -- Ongoing}}
  \href{https://github.com/kreddykhan/nanotwitter}{\textcolor{black}{\faGithubAlt}} \enskip \textbf{NanoTwitter:} Small scale Twitter app built using Ruby and Sinatra as a study in scalability\\
  \note{\textbf{\small June 2016 -- Ongoing}}
  \href{https://github.com/kreddykhan/CCD-Camera-Simulator}{\textcolor{black}{\faGithubAlt}} \enskip \textbf{CCD:} Matlab program that simulates a CCD camera using pixel bining and Riemann sums\\
  \note{\textbf{\small Jan 2015 -- May 2015}}
  \href{https://sites.google.com/a/mtholyoke.edu/cs-243-spring-15---reddy22k/home/project-2-remote-control-car}{\textcolor{black}{\faGlobe}} \enskip \textbf{Turtle 2.0:} Arduino robot with IR driven object avoidance and RF dynamic communication\\
  % \note{\textbf{\small Jan 2015 -- May 2015}}
