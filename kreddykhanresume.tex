...
\note{\fontsize{11}{12}\selectfont\textbf{#1\\[1ex]}}
\ \\
...
\begin{addmargin}[-30mm]{0mm}
  \begin{center}
    ...
    \href{https://sites.google.com/a/mtholyoke.edu/cs-243-spring-15---reddy22k/home}{sites.google.com/karishmareddykhan}\\
...
\begin{setmargins}{Experience}
  ...
  \begin{itemize}
    ...
    \item Developed image stitching protocols to stitch together experimental data results
  \end{itemize}
  \ \\[.3cm]
  ...
  \begin{itemize}
    ...
    \item Developed code in spec, a C-like software, to improve the user interface on scattering devices
  \end{itemize}
  \ \\[.3cm]
  ...
  \begin{itemize}
    \item Worked with Quantum Dots, nanoscale semi-conductors with potential solar cell applications
  ...
  \begin{itemize}
    \item Worked on Wire Position Monitors (WPMs) used to detect motion in Linear Accelerator Cavities
    \item Developed a Matlab Graphical User Interface to analyze data from WPMs that is still in use
...
\begin{setmargins}{Projects}
  ...
  \textbf{Quantum Escapement:} Implementation of an escape the room style game using Blender\\
  \note{\textbf{\small Sep 2016 -- Ongoing}}
  \textbf{NanoTwitter:} Implementation of a small scale Twitter app as a study in scalability\\
  \note{\textbf{\small June 2016 -- Ongoing}}
  \textbf{CCD:} Simulates the process of taking a photograph with a CCD camera using bining and integration\\
  \note{\textbf{\small Jan 2015 -- May 2015}}
  \textbf{Turtle 2.0:} Remote control car with object avoidance capable of dynamic communication\\
  % \note{\textbf{\small Jan 2015 -- May 2015}}
...
\begin{setmargins}{Skills}
  \textbf{Programming:} Java, Matlab, Ruby, Sinatra, Scheme, Rails, JavaScript, HTML, \LaTeX, Git, Python, spec\\ %Linux, UNIX, Assembly
  \textbf{Lab Skills:} Atomic Force Microscopy, Asylum software, spin coating, plasma cleaning, oscilloscopes\\
  \textbf{Hardware:} Arduino, SolidWorks, Blender, analog and digital circuitry, soldering, machining
\end{setmargins}
% \ \\
