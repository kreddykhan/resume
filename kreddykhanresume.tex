...
\begin{addmargin}[-30mm]{0mm}
  \begin{center}
    ...
    % \href{mailto:kreddykhan@brandeis.edu}{\textcolor{black}{kreddykhan@brandeis.edu}}\\
    % \href{https://github.com/kreddykhan}{\textcolor{black}{github.com/kreddykhan}}\\
    % \href{https://www.linkedin.com/pub/karishma-reddy-khan/a8/604/77b}{\textcolor{black}{linkedin.com/in/karishmareddykhan}}
...
\begin{setmargins}{Experience}
  \note{\textbf{\small Jan 2022--Present}}
  ...
  \begin{itemize}
    ...
    \item Completed API development, backend code inclusion and Mobile App code for new experiences
...
%   \note{\textbf{\small Oct 2016 -- Dec 2016}}
...
%   \note{\textbf{\small Sep 2016 -- Dec 2016}}
%   \note{\raggedleft\href{https://kreddykhan-nanotwitter.herokuapp.com/}{\textcolor{black}{\normalsize\faGlobe}} \href{https://github.com/kreddykhan/nanotwitter}{\textcolor{black}{\normalsize\faGithubAlt}}}
